module RPG.Component.Particle.P16 exposing (Particles)
...
update : Int -> Vec4 -> Particles -> Particles
update i data allParticles =
    case i of
        0 ->
...
vertParticles : WebGL.Shader { index : Float } Particles { data : Vec4 }
vertParticles =
    [glsl|
